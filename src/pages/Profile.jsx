...
const Profile = () => {
   ...
   const handleCityChange = (e) => {
      ...
      setCity(selectedCity); // Local state for display
      ...
      <div className="profile-page">
         ...
         <div className="profile-title-header">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
               ...
               <img src={logo} alt="Pixlo" className="profile-header-logo" onClick={() => navigate("/")} style={{ cursor: "pointer" }} />
         ...
         <div className="profile-content-container">
            <form onSubmit={handleSubmit}>
               ...
               <div className="form-grid">
                  ...
                  <div className="form-group">
                     <label>City (Fallback Location)</label>
                     <select value={Object.keys(CITIES).find(key => CITIES[key].lat === Number(formData.latitude)) || city} onChange={handleCityChange}>
